...
def run_hk_test():
    ...
    for date in all_dates:
        ...
        for t, s in cs_scores.items():
            ...
            macro_cs[t] = s * mult if s > 0 else s / mult
    ...
    print("\n" + "="*55)
    print("港股 ETF 轮动：宏观生存版对比 (2023-2025)")
    print("="*55)
    print(f"{'指标':<12} | {'纯技术面(100%)':<16} | {'技术+宏观+汇率控':<16}")
    print("-"*55)
    ...
    print(f"{'最大回撤':<12} | {bt_tech['max_drawdown']*100:>14.2f}% | {bt_advanced['max_drawdown']*100:>17.2f}%")
    print("="*55)
